...
Where continent is not null and Location not in ('World','European Union','International') and total_deaths is not null
--order by 2,3
...
Drop View CountryWise_DeathPercentage 
...
(convert(float,new_deaths)) as new_deaths_each_day,
...
Select d.continent,d.Location,d.date,d.population, convert(bigint,v.new_vaccinations) as New_Vaccinations,
